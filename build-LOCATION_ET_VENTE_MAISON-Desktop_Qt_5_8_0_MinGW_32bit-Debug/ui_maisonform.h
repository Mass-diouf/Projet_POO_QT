...
public:
    ...
    {
        MaisonForm->setWindowTitle(QApplication::translate("MaisonForm", "Ajouter une Maison", Q_NULLPTR));
        MaisonForm->setStyleSheet(QApplication::translate("MaisonForm", "background-color: white; color: black;", Q_NULLPTR));
        labelCle->setText(QApplication::translate("MaisonForm", "Cl\303\251 :", Q_NULLPTR));
        labelType->setText(QApplication::translate("MaisonForm", "Type :", Q_NULLPTR));
        comboBoxType->clear();
        comboBoxType->insertItems(0, QStringList()
         << QApplication::translate("MaisonForm", "LOCATION", Q_NULLPTR)
         << QApplication::translate("MaisonForm", "VENTE", Q_NULLPTR)
        );
        labelStanding->setText(QApplication::translate("MaisonForm", "Standing :", Q_NULLPTR));
        comboBoxStanding->clear();
        comboBoxStanding->insertItems(0, QStringList()
         << QApplication::translate("MaisonForm", "Haut", Q_NULLPTR)
         << QApplication::translate("MaisonForm", "Moyen", Q_NULLPTR)
         << QApplication::translate("MaisonForm", "Bas", Q_NULLPTR)
        );
        labelToilettes->setText(QApplication::translate("MaisonForm", "Toilettes :", Q_NULLPTR));
        labelChambres->setText(QApplication::translate("MaisonForm", "Chambres :", Q_NULLPTR));
        labelDescription->setText(QApplication::translate("MaisonForm", "Description :", Q_NULLPTR));
        pushButtonAjouterPhoto->setText(QApplication::translate("MaisonForm", "Ajouter photos", Q_NULLPTR));
        labelinfoAjouterPhoto->setText(QApplication::translate("MaisonForm", "Aucune photo ajout\303\251e", Q_NULLPTR));
        pushButtonValider->setText(QApplication::translate("MaisonForm", "Valider", Q_NULLPTR));
        labelTitre->setText(QApplication::translate("MaisonForm", "Ajouter une Maison", Q_NULLPTR));
    } // retranslateUi
