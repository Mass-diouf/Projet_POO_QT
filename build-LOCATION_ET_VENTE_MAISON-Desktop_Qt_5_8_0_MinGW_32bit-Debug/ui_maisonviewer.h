...
public:
    ...
    {
        MaisonViewer->setWindowTitle(QApplication::translate("MaisonViewer", "Dialog", Q_NULLPTR));
        labelPhoto->setText(QString());
        btnPrev->setText(QApplication::translate("MaisonViewer", " < Pr\303\251c\303\251dent ", Q_NULLPTR));
        btnNext->setText(QApplication::translate("MaisonViewer", "Suivant >", Q_NULLPTR));
        labelCle->setText(QApplication::translate("MaisonViewer", "Cle :", Q_NULLPTR));
        labelType->setText(QApplication::translate("MaisonViewer", "Type :", Q_NULLPTR));
        labelChambres->setText(QApplication::translate("MaisonViewer", "Chambres :", Q_NULLPTR));
        labelStanding->setText(QApplication::translate("MaisonViewer", "Standing :", Q_NULLPTR));
        labelToillettes->setText(QApplication::translate("MaisonViewer", "Toillettes :", Q_NULLPTR));
        labelTitre->setText(QApplication::translate("MaisonViewer", "INFORMATION MAISON", Q_NULLPTR));
        labelDescription->setText(QApplication::translate("MaisonViewer", "Descrption", Q_NULLPTR));
    } // retranslateUi
